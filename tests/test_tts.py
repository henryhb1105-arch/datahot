...
class TTSDetailRenderingTests(unittest.TestCase):
    ...
    def test_detail_actions_are_consistent_and_mobile_toolbar_stays_single_line(self):
        ...
        self.assertIn(".sharebtns .sbtn{width:56px;min-width:56px;height:44px;padding:0 6px;font-size:12px}", page)
        self.assertIn(".sharebtns .sbtn-label{display:inline}", page)
        ...
        self.assertNotIn('aria-label="原文"', page)
        self.assertIn('class="original-footer-link" href="https://example.com/article"', page)
